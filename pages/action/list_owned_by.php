 ...
 * 
 * $Id: list_owned_by.php,v 1.1 2005/03/27 19:53:21 bps7j Exp $
 */

# Create a template
$template = file_get_contents("templates/action/list_owned_by.php");
...
$res['title'] = "List All Actions You Own";
