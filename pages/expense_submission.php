 ...
 * 
 * $Id: expense_submission.php,v 1.1 2005/03/27 19:53:08 bps7j Exp $
 */

include_once("includes/authorize.php");
include_once("expense_submission.php");
include_once("expense_submission_expense.php");
include_once("expense.php");

$res['title'] = "Expense Submissions";
