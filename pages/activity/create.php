...
# Create templates
$template = file_get_contents("templates/activity/create.php");

# Create and validate the form.
$formTemplate = file_get_contents("forms/activity/create.xml");
...
if ($form->isValid()) {
    ...
    $object->insert();
    redirect("$cfg[base_url]/members/activity/read/$object->c_uid");
}
else {
...
$res['title'] = "Create a New Activity";
